...
public class BluetoothActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mBTArrayAdapter == null) {
            ...
            // List bluetooth devices when "List Paired Devices" button is clicked
            ...
            // Discover devices when "Discover" button is clicked
    ...
    // Enter here after user selects "yes" or "no" to enabling bluetooth radio
    @Override
    ...
    public AdapterView.OnItemClickListener mDeviceClickListener = new AdapterView.OnItemClickListener() {
        public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3) {
            ...
            // Get the devics, e MAC addreswhich is the last 17 chars in the View
